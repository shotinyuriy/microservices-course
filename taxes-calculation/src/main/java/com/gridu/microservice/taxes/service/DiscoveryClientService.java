 ...
 *
 */
public class DiscoveryClientService implements InitializingBean, DisposableBean {
	...
	public void sendRequestToServiceUsingEureka(EurekaClient eurekaClient) {
		...
		String vipAddress = "PRODUCT-CATALOG";
	...
	public static void main(String[] args) {
		...
		DiscoveryClientService sampleClient = new DiscoveryClientService();
	...
	public void afterPropertiesSet() throws Exception {
		...
		// use the client
		this.sendRequestToServiceUsingEureka(client);
	}
}